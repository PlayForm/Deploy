 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var c;!function(e){e[e.DEBUG=0]="DEBUG",e[e.VERBOSE=1]="VERBOSE",e[e.INFO=2]="INFO",e[e.WARN=3]="WARN",e[e.ERROR=4]="ERROR",e[e.SILENT=5]="SILENT"}(c||(c={}));const be={debug:c.DEBUG,verbose:c.VERBOSE,info:c.INFO,warn:c.WARN,error:c.ERROR,silent:c.SILENT},Ee=c.INFO,_e={[c.DEBUG]:"log",[c.VERBOSE]:"log",[c.INFO]:"info",[c.WARN]:"warn",[c.ERROR]:"error"},ye=(e,t,...r)=>{if(t<e.logLevel)return;const n=(new Date).toISOString(),a=_e[t];if(!a)throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`);console[a](`[${n}]  ${e.name}:`,...r)};class Ie{constructor(e){this.name=e,this._logLevel=Ee,this._logHandler=ye,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in c))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?be[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,c.DEBUG,...e),this._logHandler(this,c.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,c.VERBOSE,...e),this._logHandler(this,c.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,c.INFO,...e),this._logHandler(this,c.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,c.WARN,...e),this._logHandler(this,c.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,c.ERROR,...e),this._logHandler(this,c.ERROR,...e)}}const De=(e,t)=>t.some((t=>e instanceof t));let H,x;function Se(){return H||(H=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ve(){return x||(x=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const K=new WeakMap,A=new WeakMap,J=new WeakMap,D=new WeakMap,N=new WeakMap;function Ce(e){const t=new Promise(((t,r)=>{const n=()=>{e.removeEventListener("success",a),e.removeEventListener("error",i)},a=()=>{t(d(e.result)),n()},i=()=>{r(e.error),n()};e.addEventListener("success",a),e.addEventListener("error",i)}));return t.then((t=>{t instanceof IDBCursor&&K.set(t,e)})).catch((()=>{})),N.set(t,e),t}function we(e){if(A.has(e))return;const t=new Promise(((t,r)=>{const n=()=>{e.removeEventListener("complete",a),e.removeEventListener("error",i),e.removeEventListener("abort",i)},a=()=>{t(),n()},i=()=>{r(e.error||new DOMException("AbortError","AbortError")),n()};e.addEventListener("complete",a),e.addEventListener("error",i),e.addEventListener("abort",i)}));A.set(e,t)}let B={get(e,t,r){if(e instanceof IDBTransaction){if("done"===t)return A.get(e);if("objectStoreNames"===t)return e.objectStoreNames||J.get(e);if("store"===t)return r.objectStoreNames[1]?void 0:r.objectStore(r.objectStoreNames[0])}return d(e[t])},set:(e,t,r)=>(e[t]=r,!0),has:(e,t)=>e instanceof IDBTransaction&&("done"===t||"store"===t)||t in e};function Ae(e){B=e(B)}function Be(e){return e!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?ve().includes(e)?function(...t){return e.apply(S(this),t),d(K.get(this))}:function(...t){return d(e.apply(S(this),t))}:function(t,...r){const n=e.call(S(this),t,...r);return J.set(n,t.sort?t.sort():[t]),d(n)}}function Oe(e){return"function"==typeof e?Be(e):(e instanceof IDBTransaction&&we(e),De(e,Se())?new Proxy(e,B):e)}function d(e){if(e instanceof IDBRequest)return Ce(e);if(D.has(e))return D.get(e);const t=Oe(e);return t!==e&&(D.set(e,t),N.set(t,e)),t}const S=e=>N.get(e);function Te(e,t,{blocked:r,upgrade:n,blocking:a,terminated:i}={}){const s=indexedDB.open(e,t),o=d(s);return n&&s.addEventListener("upgradeneeded",(e=>{n(d(s.result),e.oldVersion,e.newVersion,d(s.transaction))})),r&&s.addEventListener("blocked",(()=>r())),o.then((e=>{i&&e.addEventListener("close",(()=>i())),a&&e.addEventListener("versionchange",(()=>a()))})).catch((()=>{})),o}const Me=["get","getKey","getAll","getAllKeys","count"],$e=["put","add","delete","clear"],v=new Map;function P(e,t){if(!(e instanceof IDBDatabase)||t in e||"string"!=typeof t)return;if(v.get(t))return v.get(t);const r=t.replace(/FromIndex$/,""),n=t!==r,a=$e.includes(r);if(!(r in(n?IDBIndex:IDBObjectStore).prototype)||!a&&!Me.includes(r))return;const i=async function(e,...t){const i=this.transaction(e,a?"readwrite":"readonly");let s=i.store;return n&&(s=s.index(t.shift())),(await Promise.all([s[r](...t),a&&i.done]))[0]};return v.set(t,i),i}Ae((e=>({...e,get:(t,r,n)=>P(t,r)||e.get(t,r,n),has:(t,r)=>!!P(t,r)||e.has(t,r)})));
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dt="firebase-heartbeat-database",ft=1,g="firebase-heartbeat-store";let C=null;function Y(){return C||(C=Te(dt,1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(g)}}).catch((e=>{throw u.create("idb-open",{originalErrorMessage:e.message})}))),C}async function ut(e){var t;try{return(await Y()).transaction(g).objectStore(g).get(X(e))}catch(e){if(e instanceof b)p.warn(e.message);else{const r=u.create("idb-get",{originalErrorMessage:null===(t=e)||void 0===t?void 0:t.message});p.warn(r.message)}}}async function j(e,t){var r;try{const r=(await Y()).transaction(g,"readwrite");return await r.objectStore(g).put(t,X(e)),r.done}catch(e){if(e instanceof b)p.warn(e.message);else{const t=u.create("idb-set",{originalErrorMessage:null===(r=e)||void 0===r?void 0:r.message});p.warn(t.message)}}}function X(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _t(e){$(new I("platform-logger",(e=>new Ne(e)),"PRIVATE")),$(new I("heartbeat",(e=>new gt(e)),"PRIVATE")),y(O,F,e),y(O,F,"esm2017"),y("fire-js","")}_t("");var yt="firebase",It="9.14.0";
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */y(yt,It,"app");const Dt={apiKey:"",appId:"",authDomain:"",databaseURL:"",measurementId:"",messagingSenderId:"",projectId:"",storageBucket:""};lt(Dt),document.documentElement.classList.remove("no-js"),document.documentElement.classList.add("js");